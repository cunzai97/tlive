...
export const en: Translations = {
  ...
  'sessionList.executionNode': '**Execution node**',
  ...
  'homeCmd.recentSessionsTitle': 'Recent sessions',
  'homeCmd.recentSessionsEmpty': 'No recoverable sessions',
  'homeCmd.recentNodeTitle': '{clientId} recent sessions',
  'homeCmd.recentNodeEmpty': 'No recoverable sessions on {clientId}',
